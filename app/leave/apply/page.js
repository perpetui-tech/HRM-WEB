...
import { Card, CardContent } from "../../../components/ui/card"; // adjust the path
...
export default function HomePage() {
  return (
    <div className="bg-white text-gray-900">
      {/* Hero Section */}
      <section className="w-full min-h-screen bg-gray-50 grid grid-cols-1 md:grid-cols-2 items-center px-10 py-20">
        <div className="space-y-6">
          <h1 className="text-5xl font-bold text-gray-800">Maatra: Empowering Businesses with Fintech & HR Tech</h1>
          <p className="text-lg text-gray-600">
            From workforce management to seamless financial services, Maatra delivers digital solutions that help businesses scale smarter.
          </p>
          <Button className="mt-4 px-6 py-3 text-white bg-blue-600 hover:bg-blue-700 rounded-2xl shadow">
            Get Started
          </Button>
        </div>
        <div className="hidden md:block">
          <img src="/maatra-dashboard.png" alt="Maatra dashboard" className="w-full rounded-xl shadow-xl" />
        </div>
      </section>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <Card className="hover:shadow-xl transition duration-300">
            <CardContent className="p-6 space-y-4">
              <h3 className="text-2xl font-semibold">HR Management</h3>
              <p>Attendance, payroll, onboarding, and compliance—all in one intelligent platform.</p>
            </CardContent>
          </Card>
          <Card className="hover:shadow-xl transition duration-300">
            <CardContent className="p-6 space-y-4">
              <h3 className="text-2xl font-semibold">Fintech Solutions</h3>
              <p>Credit underwriting, dealer financing, and real-time transaction tracking for smart financial growth.</p>
            </CardContent>
          </Card>
          <Card className="hover:shadow-xl transition duration-300">
            <CardContent className="p-6 space-y-4">
              <h3 className="text-2xl font-semibold">Integrated Dashboards</h3>
              <p>Unified data views across your organization, helping you make informed decisions at every step.</p>
            </CardContent>
          </Card>
        </div>
      </section>
      ...
      <section className="bg-blue-600 text-white py-20 px-10 text-center">
        <h2 className="text-3xl font-bold mb-4">Ready to simplify your HR & finance operations?</h2>
        <p className="mb-8">Join 1000+ businesses that trust Maatra to power their digital transformation.</p>
        <Button className="bg-white text-blue-600 font-semibold px-6 py-3 rounded-2xl hover:bg-gray-100">
          Schedule a Demo <ArrowRight className="ml-2 w-4 h-4" />
        </Button>
      </section>

      {/* Footer */}
      <footer className="bg-gray-100 py-10 px-10 grid grid-cols-1 md:grid-cols-3 gap-6 text-sm text-gray-600">
        <div>
          <h3 className="font-semibold text-lg mb-2">Maatra Technologies</h3>
          <p>Revolutionizing HR and Finance through cutting-edge software solutions.</p>
        </div>
        <div>
          <h4 className="font-semibold mb-2">Solutions</h4>
          <ul className="space-y-1">
            <li>HRMS Platform</li>
            <li>Dealer Credit Tech</li>
            <li>Custom Integrations</li>
          </ul>
        </div>
        <div>
          <h4 className="font-semibold mb-2">Contact Us</h4>
          <p>Email: contact@maatra.tech</p>
